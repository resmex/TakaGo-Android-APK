...
/** A Waste Operator registers a new driver into their own fleet, assigned to a single ward. */
public class RegisterDriverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.tvRegisterTitle)).setText("Register driver");
    ...
    private void submit() {
        ...
        if (pickedWard == null) {
            Toast.makeText(this, "Please pick this driver's ward on the map", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        dbHelper.registerDriver(name, email, phone, password, pickedWard, session.getUserId(),
                pickedLat, pickedLng, pickedRadiusKm);
