...
public class RegisterWasteOperatorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.tvRegisterTitle)).setText("Register waste operator");
    ...
    private void submit() {
        ...
        if (pickedWard == null) {
            Toast.makeText(this, "Please pick this operator's ward on the map", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        dbHelper.registerWasteOperator(name, email, phone, password, pickedWard, pickedLat, pickedLng, pickedRadiusKm);
        Toast.makeText(this, "Waste Operator registered", Toast.LENGTH_SHORT).show();
        finish();
    }
